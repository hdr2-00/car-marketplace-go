...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/register": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request or missing required fields for selected user_type",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/cars": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort by (price_asc, price_desc, year_asc, year_desc, created_asc, created_desc)",
                        "name": "sort_by",
                        "in": "query"
                    },
                    {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.CarListing"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateCarListingRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateCarListingRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.Inquiry"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/domain.CarMake"
                                            }
                                        }
                                    }
                                }
        ...
        "/reference/makes/{make_id}/models": {
            "get": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.ReviewStats"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "domain.CarListing": {
            ...
            "properties": {
                "body_type": {
                    "$ref": "#/definitions/domain.BodyType"
                },
                "body_type_id": {
                    "type": "integer"
                },
                ...
                "condition": {
                    "$ref": "#/definitions/domain.CarCondition"
                },
                "condition_id": {
                    "type": "integer"
                },
                ...
                "images": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.CarImage"
                    }
                },
                "is_featured": {
                    "type": "boolean"
                ...
                "transmission": {
                    "$ref": "#/definitions/domain.TransmissionType"
                },
        ...
        "domain.CreateCarListingRequest": {
            "type": "object",
            "required": [
                "body_type_id",
                "city",
        ...
        "domain.RegisterRequest": {
            ...
            "properties": {
                "business_name": {
                    "description": "Required when user_type is \"dealership\" or \"showroom\"",
                    "type": "string",
                ...
                "first_name": {
                    "description": "Required when user_type is \"individual\"",
                    "type": "string",
                    "example": "John"
                },
                "last_name": {
        ...
        "domain.UpdateCarListingRequest": {
            "type": "object",
            "properties": {
                "body_type_id": {
                    "type": "integer"
        ...
        "domain.User": {
            ...
            "properties": {
                ...
                "user_type": {
                    "$ref": "#/definitions/domain.UserTypeEntity"
                },
                "user_type_id": {
                    "type": "integer"
                }
